create function public.get_progress_overview_statistics(
...
revoke all on function public.get_progress_overview_statistics(uuid, integer, text)
  from public, anon;
grant execute on function public.get_progress_overview_statistics(uuid, integer, text)
  to authenticated;
...
create function public.get_progress_topics_page(
  ...
  after_chapter_position integer default null,
  after_topic_position integer default null,
